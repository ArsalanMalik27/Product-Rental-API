...
from app.api.v1.dependency.attribute_values import valid_attribute_values_dto
...
async def add_attribute(
    create_attribute_values_dto: CreateAttributeValuesDTO = Depends(valid_attribute_values_dto),
